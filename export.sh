...
export EDITOR="$(/opt/homebrew/bin/brew --prefix)/bin/nvim"
export XDG_CONFIG_HOME="$HOME/.config"
export GPG_TTY="$TTY"
export PNPM_HOME="$HOME/.local/share/pnpm"
export HISTIGNORE='*sudo -S*'
export ZSH="$HOME/.oh-my-zsh"
export ZSH_PLUGINS="$(/opt/homebrew/bin/brew --prefix)/Cellar"
...
export GITHUB_ACCOUNT="git@github.com:typesAreSpaces"
export DEV_DIR="$HOME/Documents/Projects/dev"
export WRITE_UPS_DIR="$HOME/Documents/Projects/writing"
export WEBSITE_DIR="$DEV_DIR/website"
export MATHEMATICA_PKG_DIR="$DEV_DIR/MathematicaPackages"
...
export PATH="$DEV_DIR/Singular4/bin:$PATH"
export PATH="$DEV_DIR/sdpa-gmp:$PATH"
