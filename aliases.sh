...
alias ej="fd --type f --hidden --exclude .git | fzf-tmux -p --reverse | xargs emacsclient -c -s jose -a emacs"
alias e357="fd --type f --hidden --exclude .git | fzf-tmux -p --reverse | xargs emacsclient -c -s cs357 -a emacs"
alias c="clear"
